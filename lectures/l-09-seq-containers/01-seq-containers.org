...
void print(std::list<int> &v) { std::cout << "Container: "; for(auto el: v) std::cout << el << ": " ; std::cout << std::endl;}
...
int main()
{
   std::vector<char> vec {'a','b','c','d','e'};
   //copies from 2nd element, just before 4th element
   std::list<char> li(vec.begin()+2, vec.begin()+2); 
   // copy all list to dqueue
   std::deque<char> q(li.begin(), li.end()); 
