...
#+BEGIN_SRC C++ :exports both :results output  :flags -std=c++17 -Wall --pedantic -Werror
#include <iostream>
...
#+BEGIN_SRC C++ :exports both :results output  :flags -std=c++17 -Wall --pedantic -Werror -pedantic-errors
#include <iostream>
...
#+BEGIN_SRC C++ :exports both :results output  :flags -std=c++17 -Wall --pedantic 
#include <iostream>
#include <vector>
...
#+BEGIN_SRC C++ :exports both :main no :flags -std=c++17 :results output -Wall -pedantic
#include <iostream>
#include <vector>
#include <numeric>
int main()
