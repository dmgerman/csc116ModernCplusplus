...
*** One use of accumulate requires that the operators + is defined in the class
...
int main()
{
   ...
   // only replace elements that already exist, it does not appent
   std::fill_n(col1.begin()+2, 10, 0);
   print(col1);
